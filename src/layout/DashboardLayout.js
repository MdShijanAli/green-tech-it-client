                ...
                <div className="drawer-side bg-white">
                    ...
                    <div>
                        ...
                        <div className="avatar w-full  mt-10">
                            <div className="w-24 h-24 mx-auto rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                        ...
                        <ul className="menu p-4 lg:w-80 text-base-content">
                            ...
                            <li><NavLink to='/dashboard'>All Users</NavLink></li>
                            ...
                            <li><NavLink to='/dashboard/add-a-product'>Add Product</NavLink></li>
